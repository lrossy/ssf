	...
	<div id='statBlock2'>
		...
		<div id='statTypeSelect'>
			<div class='smStatButt' id='smStat'>
				<span id='currentStat'>NHL Betting</span>
			</div>
		</div>
						...
						<table class = 'gamblingOdds'>
							...
							<tr>
								...
								<td><h3><select name='betType' id='betType' onChange='betTypeChange(this)'>
									  ...
									  <option value="gametotals">Game Totals</option>
									</select>
							...
							<tr id='gameTotal'>
								<td><h3>Game Total Spread</h3></td>
								<td><h3><input type="text" name="gameTotal" id="gameTotalInput" size="4" value="$gameStartTotal"/><span id="gameTotalToolTip"><a class="tooltip" title=""> ?</a></span></h3></td>
							</tr>
							<tr>
							<tr id='placeBet'>
								<td colspan="2">
							...
							<tr>
								<td class='leftCell'><h3><input type="radio" name="betOnTeam" value="Away" id ='awayRadio' onclick='radioChange(this);'> <label for='awayRadio'><span id='awayTeamImg'><img src='/images/team/smallteam/bluejackets.png' class='teamsRadio' /></span><div class='totalsRadio'>Less than total</div><span id="awayTeamToolTip"><a class="tooltip" title=""> ?</a></span></h3></label></td>
								<td><h3><input type="radio" name="betOnTeam" value="Home" id ='homeRadio' onclick='radioChange(this);' checked> <label for='homeRadio'><span id='homeTeamImg'><img src='/images/team/smallteam/bruins.png' class='teamsRadio' /></span><div class='totalsRadio'>Greater than total</div><span id="homeTeamToolTip"><a class="tooltip" title=""> ?</a></span></h3></label></td>
							</tr>
							<tr id='gameSpread'>
								<td class='leftCell'><h3><span class='center'>Away Spread <input type="text" name="awaySpread" id="awaySpread" size="3" value="$awayStartSpread"/></td>
								<td><h3><span class='center'>Home Spread <input type="text" name="homeSpread" id="homeSpread" size="3" value="$homeStartSpread"/></td>
							<tr>
							<tr>
								<td class='leftCell'><div class ='padBottom'><h3><span>Odds </span><input type="text" name="awayOdds" id="awayOdds"  size="3" value="$awayStartMoneyLine"/> <span id="awayOddsTooltip"><a class="tooltip" title="Enter the odds to bet on $awayTeam from your sports book (e.g., -120).">?</a></span></h3><div></td>
								<td><h3><span>Odds </span><input type="text" name="homeOdds" id="homeOdds"  size="3" value="$homeStartMoneyLine"/> <span id="homeOddsTooltip"><a class="tooltip" title="Enter the odds to bet on $homeTeam from your sports book (e.g., -120).">?</a></span></h3></td>
							</tr>
						    <tr>
							...
							<tr id="datesRow">
								<td><h3><input type="text" name="startDate" size="11" class="datepicker" value="10/01/2011"/><span id="startDateToolTip"><a class="tooltip" title=""> ?</a></span></h3></td>
							...
							<tr>
								<td colspan="2">
									<button type="button"  id='gambSubmit' name='gambSubmit' onclick='javascript:setupChart1()'>Run Scenario</button>
								</td>
							</tr>
						</table>
					</div>
