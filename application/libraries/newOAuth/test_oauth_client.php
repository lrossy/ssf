 ...
 */
	...
	/*$client->redirect_uri = 'http://'.$_SERVER['HTTP_HOST'].
		...
		client->redirect_uri = 'http://fantasysports.yahooapis.com/fantasy/v2/users;use_login=1/games;game_keys=nfl/teams';

	/* OAuth client identifier
	 * Set this to values defined by the OAuth server for your application
	 */
	$client->client_id = 'dj0yJmk9bm9uNm9hQTdNQjNyJmQ9WVdrOU1FNVFiR2t4TkhFbWNHbzlNVEUyT1RJMk56QTJNZy0tJnM9Y29uc3VtZXJzZWNyZXQmeD05MQ--';

	/* OAuth client secret
	 * Set this to values defined by the OAuth server for your application
	 */
	$client->client_secret = '057bbac71f7d3fc7aecc1a120faedece7ec6bae4';
