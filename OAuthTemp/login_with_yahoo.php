 ...
 */
	...
	$client->client_id = 'dj0yJmk9bm9uNm9hQTdNQjNyJmQ9WVdrOU1FNVFiR2t4TkhFbWNHbzlNVEUyT1RJMk56QTJNZy0tJnM9Y29uc3VtZXJzZWNyZXQmeD05MQ--'; $application_line = __LINE__;
		...
		if(($success = $client->Process()))
		{
			if(strlen($client->access_token))
			{
				$success = $client->CallAPI(
					...
					'GET', array(
						'q'=>"select * from fantasysports.teams where league_key='321.l.35241'",
						'format'=>'json'
